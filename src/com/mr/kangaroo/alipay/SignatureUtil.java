package com.mr.kangaroo.alipay;
...
public class SignatureUtil {
    ...
    private static void checkSignAndDecrypt() throws AlipayApiException {
        // 参数构建
        String biz_content = "<XML><AppId><![CDATA[2013082200024893]]></AppId><FromUserId><![CDATA[2088102122485786]]></FromUserId>" +
                "<CreateTime>1377228401913</CreateTime>" +
                "<MsgType><![CDATA[click]]></MsgType>" +
                "<EventType><![CDATA[event]]></EventType><" +
                "ActionParam><![CDATA[authentication]]></ActionParam>" +
                "<AgreementId><![CDATA[201308220000000994]]></AgreementId>" +
                "<AccountNo><![CDATA[null]]></AccountNo>" +
                "<UserInfo><![CDATA[{\"logon_id\":\"15858179811\",\"user_name\":\"许旦辉\"}]]></UserInfo></XML>";
